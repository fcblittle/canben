...
(function(e, g) {
        ...
        y = x(w, {
            ...
            initContainer: function() {
                ...
                this.search.bind("keydown", this.bind(function(a) {
                    if (this.enabled) if (a.which === f.PAGE_UP || a.which === f.PAGE_DOWN) l(a);
                ...
                a.bind("keydown", this.bind(function(a) {
                    if (this.enabled) if (a.which === f.PAGE_UP || a.which === f.PAGE_DOWN) l(a);
                    else if (!(a.which === f.TAB || f.isControl(a) || f.isFunctionKey(a) || a.which === f.ESC) && !(!1 === this.opts.openOnEnter && a.which === f.ENTER)) if (a.which == f.DELETE) this.opts.allowClear && this.clear();
                    else {
                        this.open();
 ...
 //alert("value:"+d);
            ...
            unselect: function(a) {
                ...
                $("#hid_feature").val(b);//zaichen add
                $("#hid_feature_num").val(d);//zaichen add
                //alert("afterClosed:"+b);
                //alert("nums:"+d);
            },
        ...
        e.fn.select2 = function() {
            var a = Array.prototype.slice.call(arguments, 0),
                b, c, d, f, h = "val destroy opened open close focus isFocused container onSortStart onSortEnd enable disable positionDropdown data".split(" ");
            this.each(function() {
