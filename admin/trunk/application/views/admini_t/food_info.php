...
<div id="content">
  ...
  <div class="container-fluid"><hr>
	<a href="<?php echo site_url('/admini/dashboard/foodlist/'.$id);?>"><button class="btn btn-danger">菜品列表</button></a>
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
			...
			$hidden = array("id"=>$id);
			echo form_open_multipart('/admini/doadd/foodinfo',$attributes,$hidden);?>
				...
				<a class="btn btn-info" href="<?php echo site_url('/admini/dashboard/foodlist/'.$id);?>" >返回</a>
                </div>
  <!--          </form>-->
          </div>
        </div>
