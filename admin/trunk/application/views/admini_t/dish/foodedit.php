                    ...
                    <div class="widget-content nopadding">
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <textarea name="intro" rows="7" placeholder="餐品详情，配料等基本信息录入" style="width: 410px;resize: none;"><?php echo isset($item->intro)?$item->intro:'';?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">菜品详情</label>
                                <div class="controls">
                                    <textarea class="span6" id="container" name="description" rows="5"><?php echo isset($item)?$item->description : ''?></textarea>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="form-actions">
                                ...
                                <a class="btn btn-info" href="/admini/cityfood/foodlist?city_id=<?php echo $city_id; ?>" >关闭</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script id="materials-tpl-add" type="text/html">
    <tr>
        ...
        <td class="unit">
                <?php if(!empty($v->unit)) {echo($v->unit);}?>
        </td>
