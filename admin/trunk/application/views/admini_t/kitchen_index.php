...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                <a href="<?php echo site_url('/admini/kitchen/add');?>" ><button class="btn btn-danger">新增</button></a>
                        ...
                        <table class="table table-bordered">
                            ...
                            <?php foreach($list as $k => $v): ?>
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-mini" href="<?php echo site_url('/admini/kitchen/edit/'.$v->id);?>">编辑</a>
                                        <a class="btn btn-danger confirm btn-mini" href="<?php echo site_url('/admini/kitchen/delete/'.$v->id);?>">删除</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <?php endif ?>
