...
<div id="content">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                <a href="<?php echo site_url('/admini/dishTag/add');?>" ><button class="btn btn-danger">新增</button></a>
                        ...
                        <table class="table table-bordered ">
                            ...
                            <?php foreach($list as $k => $v): ?>
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <a class="btn btn-info btn-mini" href="<?php echo site_url('/admini/dishTag/edit/'.$v->id);?>">编辑</a>
                                        <a class="btn btn-danger btn-mini confirm" href="<?php echo site_url('/admini/dishTag/delete/'.$v->id);?>">删除</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
