    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> 
              ...
              <a href="<?php echo site_url('/admini/fund/manager');?>">经营者资金管理</a>
              <a href="#" class="current">经营者(<?=$realname;?>)往来明细</a>
            </div>
            <h1>经营者(<?=$realname;?>)账户往来明细</h1>
        </div>
        <!--End-breadcrumbs-->
                    ...
                    <div class="widget-box">
                        <div class="widget-title">
                            <ul class="nav nav-tabs">
                                <li <?php if(empty($_GET['type']) || $_GET['type'] == 'wallet') echo 'class="active"';?>><a href="<?php echo site_url('/admini/fund/manager_detail/'.$staff_id);?>?type=wallet">我的钱包</a></li>
                                <li <?php if($_GET['type'] == 'account') echo 'class="active"';?>><a href="<?php echo site_url('/admini/fund/manager_detail/'.$staff_id);?>?type=account">经营账户</a></li>
                            </ul>
                        </div>
