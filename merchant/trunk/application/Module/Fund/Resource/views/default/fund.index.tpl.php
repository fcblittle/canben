                                ...
                                <div class="widget-content">
                                    <div class="controls controls-row">
                                        ...
                                        <span class="span3">账户余额：
                                            <font style="font-weight: bold;"><?=$statistics['data']['balance'];?></font>
                                        </span>
                                        <span class="span3">
                                            <?php echo $statistics['frequency'] == 'Day' ? '今日' : '本月' ;?>总收入：￥
                                            <font style="font-weight: bold;"><?=$statistics['data']['income'];?></font>
                                        </span>
                                        <span class="span3">
                                            <?php echo $statistics['frequency'] == 'Day' ? '今日' : '本月' ;?>总支出：￥
                                            <font style="font-weight: bold;"><?=$statistics['data']['outcome'];?></font>
                                        </span>
                                    </div>
                                </div>
                            </div>
