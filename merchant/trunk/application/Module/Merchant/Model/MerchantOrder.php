...
class MerchantOrder extends Model {
     ...
     * 添加
     */
    public function add($merchantId, $data, $date = '') {
    ...
    public function getOrderList($params) {
        ...
        $sql = "SELECT {$params['fields']}"
            ...
            // var_dump($sql);var_dump($binds);die;
    ...
    public function getList($params = array()) {
        ...
        if ($params['confirmed_start'] !== null) {
            $conds .= " AND a.time_send BETWEEN ? AND ?";
    ...
    public function getOrderDetail($orderid,$fields = "od.*, d.food_name, d.images"){
