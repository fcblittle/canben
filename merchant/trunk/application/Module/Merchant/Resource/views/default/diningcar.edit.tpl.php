                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" disabled required value="<?=$item->car_license_plate?>"> <span class="help-inline">请联系客服修改</span>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">经营区域</label>
                                    <div class="controls">
                                        <input type="text" disabled required id="" value="<?php echo $areas[$item->area]->area ?>"> <span class="help-inline">请联系客服修改</span>
                                    </div>
                                </div>
                                <div class="control-group">
