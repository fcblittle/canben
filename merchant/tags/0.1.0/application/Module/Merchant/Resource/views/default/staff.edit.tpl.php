...
<?php $this->region('Module\Common:sidebar') ?>
    ...
    <div id="content">
        ...
        <div id="content-header">
            <div id="breadcrumb"> <a href="/" title="返回首页" class="tip-bottom"><i class="icon-home"></i>首页</a> <a href="#" title="" class="tip-bottom">编辑店员信息</a></div>
        </div>
        <!--End-breadcrumbs-->
                        ...
                        <div class="widget-content nopadding">
                            <form class="form-horizontal" method="post" action="#" name="basic_validate" id="basic_validate" novalidate="novalidate">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="username" maxlength="30" required id="" value="<?php echo $_POST['username'] ?: $item->username ?>">
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label>
                                            ...
                                            餐车管理员</label>
                                        <label>
                                            <input type="radio" name="role" value="2" <?php if ($item->role == 2): echo 'checked'; endif; ?>/>
                                            店小二</label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select name="diner_id" style="width:218px">
                                            <?php if ($cars): foreach ($cars as $v): ?>
                                            <option value="<?=$v->id ?>"><?=$v->diner_name ?></option>
